                        ...
                        <li class="hoverSub" ><a href="">Bags</a>
                            ...
                            <div class="sub-menu2">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">BAG PACKS</a></li>
                                    <li><a href="#">CLUTCHES</a></li>
                                    <li><a href="#">SATCHERS</a></li>
                                ...
                                <div class="flexSub">
                                    <h5>Shop By List</h5>
                                <ul>
                                    <li><a href="#">DRAW ON STRAW</a></li>
                                    <li><a href="#">CRISP WHITE BAGS</a></li>
                                    <li><a href="#">HANDS FREE</a></li>
                                    <li><a href="#">BUCKET BAG LIST</a></li>
                                    <li><a href="#">SLEEK MINI BAGS</a></li>
                                </ul>
                                </div>
                            </div>
                        </li>
                        <li class="hoverSub"><a href="#">Shoes</a>
                            <div class="sub-menu2">
                                <div class="flexSub">
                                    <h5>Shop By Category</h5>
                                <ul>
                                ...
                                <ul>
                                    <li><a href="#">DRAW ON STRAW</a></li>
                                    <li><a href="#">STRAPY SANDALS</a></li>
                                    <li><a href="#">LOW HEELS</a></li>
                                    <li><a href="#">PLATFORM SHOES</a></li>
                                    <li><a href="#">SPRING SANDALS</a></li>
                                </ul>
                                </div>
                            </div>
                        </li>
                        <li class="hoverSub"><a href="#">Accessories</a>
                            <div class="sub-menu2">
                                <div class="flexSub">
                                    <h5>Shop By Category</h5>
                                <ul>
                                ...
                                <div class="flexSub">
                                    <h5>Shop By List</h5>
                                <ul>
                                    <li><a href="#">STATEMENT JEWELRY</a></li>
                                    <li><a href="#">EYE CANDY</a></li>
                                    <li><a href="#">DRAW ON STRAW</a></li>
                                </ul>
                                </div>
                            </div>
                        ...
                        <li class="hoverSub"><a href="beauty.html">Beauty</a>
                            ...
                            <div class="sub-menu2">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">COSMETICS CASES</a></li>
                        ...
                        <li class="hoverSub"><a href="#">Clothing</a>
                            <div class="sub-menu2">
                                ...
                                <div class="flexSub">
                                    <h5>Shop By List</h5>
                                <ul>
                                    <li><a href="#">LUXURY T-SHIRTS</a></li>
                                    <li><a href="#">TOP TANK TOPS</a></li>
                                    <li><a href="#">BUTTON DOWN'S</a></li>
                                    <li><a href="#">SHORT SHORT'S</a></li>
                                    <li><a href="#">DENIM DAZE</a></li>
                                    <li><a href="#">FEELING TRANSPARENT</a></li>
                                    <li><a href="#">VESTED INTEREST</a></li>
                                </ul>
                                </div>
                        ...
                        <li class="hoverSub"><a href="#">Shoes</a>
                            <div class="sub-menu2">
                                ...
                                <div class="flexSub">
                                    <h5>Shop By List</h5>
                                <ul>
                                    <li><a href="#">SUN'S OUT, TOE'S OUT</a></li>
                                    <li><a href="#">SLEEK SANDALS</a></li>
                                    <li><a href="#">MEN'S DRESS SHOES</a></li>
                                    <li><a href="#">SPRING SANDALS STAPLE</a></li>
                                </ul>
                                </div>
                            </div>
                        </li>
                        <li class="hoverSub"><a href="#">Accessories</a>
                            <div class="sub-menu2">
                                ...
                                <div class="flexSub">
                                    <h5>Shop By List</h5>
                                <ul>
                                    <li><a href="#">SPRING ACCESSORIES</a></li>
                                    <li><a href="#">CAUGHT FOR EYE</a></li>
                                    <li><a href="#">MUST HAVE ACCESSORIES</a></li>
                                </ul>
                                </div>
                            </div>
                        </li>
                        <li class="hoverSub"><a href="#">Grooming</a>
                            <div class="sub-menu2">
                                <div class="flexSub">
                                    <h5>Shop By Category</h5>
                                <ul>
                                    <li><a href="#">NEW ARRIVALS</a></li>
                                    <li><a href="#">ALL GROOMING</a></li>
                                    <li><a href="#">BATH & BODY</a></li>
                                ...
                                <div class="flexSub">
                                    <h5>Shop By DESIGNERS</h5>
                                <ul>
                                    <li><a href="#">GUCCI</a></li>
                                    <li><a href="#">DOLCE & GABBANA</a></li>
                                    <li><a href="#">AESOP</a></li>
                                    <li><a href="#">LANVIN</a></li>
                                    <li><a href="#">SAINT LAURENT</a></li>
            ...
            <li> <a href="#">SALE</a>
                <div class="sub-menu1">
                    <ul>
                        ...
                        <li><a href="#">BEAUTY'S SALE</a></li>
                        <li><a href="#">KID'S SALE</a></li>
                        <li><a href="#">HOME'S SALE</a></li>
                    </ul>
                </div>
            </li>
        </ul>
